...
void local_search(candidate_solution & best, std::vector<std::vector<double> > & cities, size_t max_no_improv, size_t neighborhood)
{
	size_t count = 0;
...
void search(candidate_solution & best, std::vector<std::vector<double> > & cities,
	std::vector<size_t> & neighborhoods, size_t max_no_improv, size_t max_no_improv_ls)
{
